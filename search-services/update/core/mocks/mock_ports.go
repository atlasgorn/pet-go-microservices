...
// Source: update/core/ports.go
//
// Generated by this command:
//
//	mockgen -source=update/core/ports.go -destination=update/core/mocks/mock_ports.go -package=mocks
//
...
// NotifyDBUpdate mocks base method.
func (m *MockBroker) NotifyDBUpdate() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NotifyDBUpdate")
	ret0, _ := ret[0].(error)
	return ret0
}

// NotifyDBUpdate indicates an expected call of NotifyDBUpdate.
func (mr *MockBrokerMockRecorder) NotifyDBUpdate() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NotifyDBUpdate", reflect.TypeOf((*MockBroker)(nil).NotifyDBUpdate))
}
